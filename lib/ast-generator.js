...
// Example usage:
// const query1 = '`firstname`="John" AND `lastname`="Carter" OR `lastname`="Cena" AND rank>=75 OR rollnum>100 AND `age` BETWEEN 20 AND 25 OR `city` IN ("Delhi","Mumbai","Chennai") OR `state` LIKE "Mah" AND `school` IS NOT "Xavier" OR `school` IS "Vidya Mandir"';
// const query2 = 'firstname="John" AND lastname="Carter" OR lastname="Cena" AND active IS TRUE OR NOT passive=1 AND rank>=75 OR rollnum>100 AND age BETWEEN 20 AND 25 OR city IN ("Delhi", "Mumbai","Chennai") OR state LIKE "Mah" AND school IS NOT "Xavier" OR school IS "Vid=y>a Mandir"';
// const query3 = 'firstname = "John" AND lastname = "Carter" OR lastname = "Cena" AND rank >= 75 OR rollnum > 100 AND age NOT BETWEEN 20 AND 25 OR city IN ("Delhi","Mumbai","Chennai") OR state LIKE "Mah" AND school IS NOT "Xavier" OR school IS "Vidya Mandir"';
// const query4 = `((((((((((("firstname" = "John" AND "lastname" = "Carter") OR "lastname" = "Cena") AND "active" IS NOT "TRUE") OR NOT "passive" = 1) AND "rank" >= 75) OR "rollnum" > 100) AND "age" NOT BETWEEN 20 AND 25) OR "city" NOT IN ("Delhi", "Mumbai", "Chennai")) OR "state" NOT LIKE "Mah") AND "school" IS NOT "Xavier") OR "school" IS  "Vid=y>a Mandir")`;

// const astGenerator = new ASTGenerator();
// const ast = astGenerator.generateAST(query2);
// console.log(astGenerator.recreateExpression(ast));
// console.log(astGenerator.toJavaScript(ast));