export default class SelectParser {
  ...
  parseDistinct() {
    ...
    if (this.tokens[this.currentTokenIndex] && this.tokens[this.currentTokenIndex].type === 'asterisk') {
      distinct.column = this.tokens[this.currentTokenIndex].value;
      this.currentTokenIndex++;
    } else if (this.tokens[this.currentTokenIndex] && this.tokens[this.currentTokenIndex].type === 'identifier') {
      distinct.column = this.tokens[this.currentTokenIndex].value;
      this.currentTokenIndex++;
    }
